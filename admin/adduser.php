...
<h2><a href="index.php">To Live Is To Serve</a></h2>
 ...
 <!-- <div id="header-search">
  ...
  <div id="page">
	...
	<div class="all"><label></label><input type="hidden" id="pid" value="3" name="pid"></div>	
	<div class="all"><label>Name</label><input type="text" id="sname" name="sname" required></div>
    ...
    <div class="all"><label>Rank</label>
	...
	<div class="all"><label></label><button type="submit" id="sbasysuser">Add</button></div>
	<div class="all"></div>
	</form>
