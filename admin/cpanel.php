  ...
  <div id="page">
    <div id="page-bgtop">
      ...
      <div id="feedback" style="background:transparent; color:white; font-size:18px; padding:1px; margin:1% 32% 2px 32%; height:auto; width:350px; text-align:center; border-radius:3px;"></div>
        ...
        <center>
			<table cellpadding="15px" style="margin-top:10%;">
		
				<tr>
				
				<td><button id="grabdata"><a href="biodata.php" target="_blank" title="Add A New Client"><img src="../images/edit.png" height="150px" width="auto"></a></button></td>
               <?php 
			   
			   if($me->haveexternalrights()==1){  
			   echo 
			   "<td>
			   <a href='bills.php' target='_blank' title='View/Create Bills'><button id=;grabdata;><img src='../images/sales.jpg' height='150px' width='auto'></a></button>
			   ...
			   ";
				 ...
				 /*<td>
			   <a href='adduser.php' target='_blank' title='Add Users'><button id=;grabdata;><img src='../images/adduser.png' height='150px' width='auto'></a></button>
                 ...
                 <td><a href="existing.php" target="_blank" title="Place An Order For Existing Client"><button id="grabdata"><img src="../images/men63.png" height="150px" width="auto"></a></button></td>
