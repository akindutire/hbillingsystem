    ...
    <div id="page-bgtop">
      ...
      <div id="feedback" style="background:transparent; color:white; font-size:18px; padding:1px; margin:1% 32% 2px 32%; height:auto; width:350px; text-align:center; border-radius:3px;"></div>
        ...
        <center>
        	...
        	<form action="placeorder2.php" method="post">
                ...
                <select name="cat" id="cat">
                	...
                	<?php $sql=mysqli_query($link,"SELECT id,cat FROM category");
                ...
                <div class="all"><label>Section</label>
                
                <select name="section" id="section">
                
                	<?php 
						echo "<option value='1'>Laboratory Test</option>";
						echo "<option value='2'>Disease</option>";
                ...
                <div class="all"><label>Disease/Test</label>
                
                <cc><select name="node" id="node">
            	...
            	<div class="all"><input type="hidden" name="rtid"  value="1"></div>
                <div class="all"><label></label><button type="submit" id="chcat">Explore</button></div>
                 <div class="all"></div>
            </form>
