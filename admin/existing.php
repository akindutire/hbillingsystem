      ...
      <div id="feedback" style="background:transparent; color:black; font-size:18px; padding:1px; margin:1% 32% 2px 32%; height:auto; width:350px; text-align:center; border-radius:3px;"></div>
        ...
        <center>
        	...
        	<form action="" method="post">
            	 ...
            	 <div class="all"><label>Card No.</label>
                
               <input name="cardno" id="cardno" type="text" maxlength="8" />
                
                
                
                
                <div class="all"><label></label><button type="submit" id="vcard">Verify</button></div>
                 <div class="all"></div>
            </form>
