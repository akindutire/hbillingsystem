...
<title>Joe Jane| Place Order-Cont</title>
...
<h2><a href="index.php">To Live Is To Serve</a></h2>
  ...
  <div id="menu">
    <ul>
      ...
      <li><a href="placeorder.php">Back</a></li>
    </ul>
  </div>
		...
		if($section==1){
			...
			while(list($id,$testcat,$testname,$charges)=mysqli_fetch_row($sql)){
				...
				echo "<tr>
						...
						<td>$scat</td>
						<td>$testname</td>
						<td><input type='number' id='upcharge' data-utype='1' data-ctid='$id' name='charges'  value='$charges' style='text-align:center;' readonly></td>
						<td><a title='Order' href='placeorder3.php?did=$id&&sect=$section'><img src='../images/hbill.png' height='15px'></a></td>
			...
			while(list($id,$cat_id,$dname,$charges)=mysqli_fetch_row($sql)){
				...
				echo "<tr>
						...
						<td>$scat</td>
						<td>$dname</td>
						<td><input style='text-align:center;' type='number' id='upcharge' data-utype='2' data-ctid='$id' name='charges'  value='$charges' readonly></td>
						<td><a title='Order' href='placeorder3.php?did=$id&&sect=$section'><img src='../images/hbill.png' height='15px'></a></td>
				</tr>";
