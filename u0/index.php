...
<div id="wrapper">
  <div id="header">
    <div id="logo">
      <blockquote>
        <h1><a href="index.php">Joe-Jane Medical Centre</a></h1>
      </blockquote>
<h2><a href="index.php">To Live Is To Serve</a></h2>
  ...
  <div id="splash"><img src="../images/img04.jpg" width="940px" alt="" /></div>
  ...
  <div id="page">
    <div id="page-bgtop">
      <div id="content">
       ...
       <form action="ulogin" method="post" style="text-align:start; margin:20% 2% 1% 2%; color:white;">
